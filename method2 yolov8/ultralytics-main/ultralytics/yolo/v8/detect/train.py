...
def train(cfg=DEFAULT_CFG, use_python=False):
    ...
    data = cfg.data or 'E:/ultralytics-main/ultralytics/datasets/HG_iron/data.yaml'  # or yolo.ClassificationDataset("mnist")
    device = cfg.device if cfg.device is not None else '0'
    args = dict(model=model, data=data, device=device, epochs=200, imgsz=640, lr0=0.0497, lrf=0.0497)
    if use_python:
