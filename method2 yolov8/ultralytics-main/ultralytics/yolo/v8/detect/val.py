...
def val(cfg=DEFAULT_CFG, use_python=False):
    ...
    model = cfg.model or 'E:/ultralytics-main/ultralytics/yolo/v8/detect/runs/detect/train/weights/best.pt'
    data = cfg.data or 'E:/ultralytics-main/ultralytics/datasets/HG_iron/data.yaml'
